...
<head>
    ...
    <title>Panel admina - Zgłoszenia - Oceny restauracji</title>
  ...
  <div class="flex items-start justify-center md:mt-10">
    <div class="mx-auto max-w-2xl w-full dark:bg-gray-800 bg-white rounded-md shadow-lg p-8">
      ...
      <div class="grid grid-cols-3 gap-4">
        <a href="reports.php" class="block border-2 border-gray-900 bg-gray-900 text-white rounded-md py-2 w-full text-center">Zgłoszenia</a>
      ...
      <div class="mt-6">
        <div class="text-xl italic font-bold mb-2">Zgłoszenia</div>
        <div>
          <?php
            if ($reports) {
              ?>
              ...
              <?php
                foreach ($reports as $report) {
                  $sql = "SELECT * FROM comments WHERE id=" . $mysqli->real_escape_string($report['comment_id']);
                  $result = $mysqli->query($sql);
